...
const FILTER_TYPE_FAMILIES = {
  ...
  'vpn-group':      [NODE_TYPES.VPN_GROUP,      NODE_TYPES.VPN_SUBGROUP,         NODE_TYPES.VPN_DEVICE],
  'firewall-group': [NODE_TYPES.FIREWALL_GROUP, NODE_TYPES.FIREWALL_SUBGROUP,    NODE_TYPES.FIREWALL],
  ...
  'server-group':   [
    NODE_TYPES.SERVER_GROUP,
    NODE_TYPES.WEB_SERVER_GROUP,  NODE_TYPES.APP_SERVER_GROUP, NODE_TYPES.DB_SERVER_GROUP,
    NODE_TYPES.AD_SERVER_GROUP,   NODE_TYPES.MAIL_SERVER_GROUP,NODE_TYPES.FILE_SERVER_GROUP,
    NODE_TYPES.MONITORING_GROUP,  NODE_TYPES.BACKUP_GROUP,
    NODE_TYPES.WEB_SERVER, NODE_TYPES.APP_SERVER, NODE_TYPES.DB_SERVER,
    NODE_TYPES.AD_SERVER,  NODE_TYPES.MAIL_SERVER,NODE_TYPES.FILE_SERVER,
    NODE_TYPES.MONITORING_SERVER, NODE_TYPES.BACKUP_SERVER,
  ],
  'laptop-group':   [NODE_TYPES.LAPTOP_GROUP,   NODE_TYPES.REGION_GROUP, NODE_TYPES.LAPTOP],
  'desktop-group':  [NODE_TYPES.DESKTOP_GROUP,  NODE_TYPES.DESKTOP],
  'mobile-group':   [NODE_TYPES.MOBILE_GROUP,   NODE_TYPES.MOBILE],
  'guest-group':    [NODE_TYPES.GUEST_GROUP,     NODE_TYPES.GUEST_DEVICE],
};
